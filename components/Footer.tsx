...
export const Footer = () => {
  return (
    <footer className="bg-[var(--color-primary-dark)] text-white pt-20 pb-10 border-t border-[var(--color-primary-soft)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          <div className="lg:col-span-2">
            ...
            <div className="p-4 rounded-lg bg-[var(--color-primary-soft)]/50 border border-white/10 text-sm text-white/80">
              <span className="font-semibold text-white block mb-1">Operating Model</span>

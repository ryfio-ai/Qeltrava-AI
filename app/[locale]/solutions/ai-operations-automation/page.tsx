...
export const metadata: Metadata = {
  ...
  description: 'Discover how Qeltrava AI approaches ai operations automation to deliver measurable business outcomes and architectural precision.',
};
        ...
        <FadeIn>
          <div className="mb-16">
            ...
            <p className="text-xl text-[var(--color-text-main)] leading-relaxed max-w-3xl">
              Discover how Qeltrava AI approaches ai operations automation to deliver measurable business outcomes and architectural precision.
            </p>
          </div>
        </FadeIn>
        ...
        <section className="mb-20">
          <FadeIn direction="up">
            ...
            <p className="text-[var(--color-text-main)] mb-6">
              We do not sell hours. We sell capabilities. By integrating AI deeply into your internal workflows, we eliminate operational friction and accelerate processing times across finance, HR, and administrative departments.
            </p>
          </FadeIn>
        </section>

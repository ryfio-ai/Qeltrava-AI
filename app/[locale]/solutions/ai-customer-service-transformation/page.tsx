...
export const metadata: Metadata = {
  ...
  description: 'Discover how Qeltrava AI approaches ai customer service transformation to deliver measurable business outcomes and architectural precision.',
};
        ...
        <FadeIn>
          <div className="mb-16">
            ...
            <p className="text-xl text-[var(--color-text-main)] leading-relaxed max-w-3xl">
              Discover how Qeltrava AI approaches ai customer service transformation to deliver measurable business outcomes and architectural precision.
            </p>
          </div>
        </FadeIn>

        <section className="mb-20">
          <VisualCustomerServiceSolutions />
        </section>
        ...
        <section className="mb-20">
          <FadeIn direction="up">
            ...
            <p className="text-[var(--color-text-main)] mb-6">
              We do not sell hours. We sell capabilities. We deploy sophisticated conversational AI agents capable of resolving complex customer queries instantly, drastically reducing support tickets and improving user satisfaction.
            </p>
          </FadeIn>
        </section>

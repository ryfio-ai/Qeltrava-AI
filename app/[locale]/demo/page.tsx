...
export default function DemoShowcasePage() {
  ...
  return (
    <main className="min-h-screen bg-[var(--color-bg-light)] pb-24 pt-8">
      ...
      {/* Illustrative Laboratory & Demo Showcase Notice */}
      <div className="max-w-7xl mx-auto px-6 md:px-12 mb-8">
        <div className="bg-blue-50/80 border border-blue-200/80 p-5 rounded-2xl shadow-xs">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-sm font-extrabold text-blue-900 uppercase tracking-wider mb-1">
                Illustrative laboratory & demo showcase
              </h3>
              <p className="text-xs text-blue-700 leading-relaxed">
                The interactive components, metrics, and models below are visual simulations designed to demonstrate our front-end engineering, custom charting, and interactive design capabilities. No live system telemetry or customer analytics are processed on this page.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 mb-8">
        <div className="bg-white border border-[var(--color-border-soft)] rounded-2xl p-6 shadow-sm grid grid-cols-2 md:grid-cols-4 gap-6">
          <div>
            <span className="text-[10px] uppercase font-mono tracking-wider text-gray-400">Total API Invocations (Simulated)</span>

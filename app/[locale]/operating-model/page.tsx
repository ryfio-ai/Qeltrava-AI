  ...
  return (
    <main className="min-h-screen bg-[var(--color-bg-white)] pt-32 pb-24">
      <div className="max-w-5xl mx-auto px-6 md:px-12 flex flex-col gap-16">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 bg-white border border-[var(--color-border-soft)] rounded-xl shadow-sm">
              ...
              <p className="text-sm text-[var(--color-text-main)]">We begin with an AI Opportunity Audit or Discovery Sprint to map your current workflow, estimate ROI, and create a 90-day implementation roadmap.</p>
            </div>
            <div className="p-6 bg-white border border-[var(--color-border-soft)] rounded-xl shadow-sm">
              <h3 className="font-bold text-lg text-[var(--color-primary-dark)] mb-2">2. Architect & Build</h3>
              <p className="text-sm text-[var(--color-text-main)]">Engineering pods build multi-tenant, secure, and scalable prototypes and MVPs without accumulating technical debt from day one.</p>
            </div>
            <div className="p-6 bg-white border border-[var(--color-border-soft)] rounded-xl shadow-sm">
              <h3 className="font-bold text-lg text-[var(--color-primary-dark)] mb-2">3. Validate & Deploy</h3>
              <p className="text-sm text-[var(--color-text-main)]">Every project undergoes strict QA, security reviews, automated testing, and performance checks before production deployment.</p>
            </div>
            <div className="p-6 bg-white border border-[var(--color-border-soft)] rounded-xl shadow-sm">
              <h3 className="font-bold text-lg text-[var(--color-primary-dark)] mb-2">4. Optimize (Retainers)</h3>
              <p className="text-sm text-[var(--color-text-main)]">Post-launch, we provide dedicated engineering pods or support retainers to monitor AI agents, manage cloud infrastructure, and continuously iterate the product.</p>
            </div>
          </div>
        </section>

        {/* How Software Companies Work Spine */}
        <section>
        ...
        {/* Pricing Philosophy */}
        <section>
          <h2 className="text-2xl font-bold text-[var(--color-primary-dark)] mb-6 border-b border-[var(--color-border-soft)] pb-4">Pricing Philosophy</h2>
          ...
          <ul className="list-disc pl-6 text-[var(--color-text-main)] space-y-2 mb-8 text-sm">

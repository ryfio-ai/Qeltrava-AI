        ...
        <section className="mb-20">
          <FadeIn direction="up">
            ...
            <p className="text-[var(--color-text-main)] mb-6">
              We do not sell hours. We sell capabilities. Our product engineering goes beyond writing code. We architect scalable solutions from the ground up, ensuring that every feature maps directly to user needs and core business objectives.
            </p>
          </FadeIn>
        </section>

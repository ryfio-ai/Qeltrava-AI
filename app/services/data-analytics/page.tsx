...
export const metadata: Metadata = {
  title: 'Data Analytics Engineering | ' + siteConfig.companyName,
  description: 'We design and deploy enterprise-grade data analytics systems that automate complex workflows, reduce operational overhead, and ensure absolute compliance.',
};
  ...
  return (
    <main className="min-h-screen bg-[var(--color-bg-white)] pt-32 pb-24">
      <div className="max-w-5xl mx-auto px-6 md:px-12">
        <FadeIn>
          <div className="mb-16">
            <h1 className="text-4xl md:text-5xl font-bold text-[var(--color-primary-dark)] mb-6">Data Analytics Engineering</h1>
            <p className="text-xl text-[var(--color-text-main)] leading-relaxed max-w-3xl">
              We design and deploy enterprise-grade data analytics systems that automate complex workflows, reduce operational overhead, and ensure absolute compliance.
            </p>
          </div>
        </FadeIn>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <FadeIn delay={0.1}>
              <div className="p-6 bg-white border border-[var(--color-border-soft)] rounded-xl shadow-sm h-full">
                ...
                <p className="text-sm font-medium text-[var(--color-primary-dark)]">Reduced manual intervention by up to 80%</p>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={0.2}>
              <div className="p-6 bg-white border border-[var(--color-border-soft)] rounded-xl shadow-sm h-full">
                ...
                <p className="text-sm font-medium text-[var(--color-primary-dark)]">Enterprise-grade security and RBAC</p>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={0.3}>
              <div className="p-6 bg-white border border-[var(--color-border-soft)] rounded-xl shadow-sm h-full">
                ...
                <p className="text-sm font-medium text-[var(--color-primary-dark)]">Seamless integration with existing architectures</p>
              </div>
            </FadeIn>
        ...
        <section className="mb-20">
          <FadeIn direction="up">
            ...
            <p className="text-[var(--color-text-main)] mb-6">
              We do not sell hours. We sell capabilities. Every architecture decision in our Data Analytics Engineering solutions is measured against its ability to reduce costs, increase revenue, or mitigate risk. We build secure, scalable platforms using our Quantra Delivery OS.
            </p>
          </FadeIn>
        </section>

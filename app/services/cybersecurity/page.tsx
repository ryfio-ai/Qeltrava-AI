...
export const metadata: Metadata = {
  title: 'Cybersecurity Engineering | ' + siteConfig.companyName,
  description: 'We design and deploy enterprise-grade cybersecurity systems that automate complex workflows, reduce operational overhead, and ensure absolute compliance.',
};
  ...
  return (
    <main className="min-h-screen bg-[var(--color-bg-white)] pt-32 pb-24">
      <div className="max-w-5xl mx-auto px-6 md:px-12">
        <FadeIn>
          <div className="mb-16">
            <h1 className="text-4xl md:text-5xl font-bold text-[var(--color-primary-dark)] mb-6">Cybersecurity Engineering</h1>
            <p className="text-xl text-[var(--color-text-main)] leading-relaxed max-w-3xl">
              We design and deploy enterprise-grade cybersecurity systems that automate complex workflows, reduce operational overhead, and ensure absolute compliance.
            </p>
          </div>
        </FadeIn>
        ...
        <section className="mb-20">
          <FadeIn direction="up">
            ...
            <p className="text-[var(--color-text-main)] mb-6">
              We do not sell hours. We sell capabilities. Every architecture decision in our Cybersecurity Engineering solutions is measured against its ability to reduce costs, increase revenue, or mitigate risk. We build secure, scalable platforms using our Quantra Delivery OS.
            </p>
          </FadeIn>
        </section>

...
export const metadata: Metadata = {
  title: 'Privacy | ' + siteConfig.companyName,
  description: 'Discover how Quantra AI approaches privacy to deliver measurable business outcomes and architectural precision.',
};
  ...
  return (
    <main className="min-h-screen bg-[var(--color-bg-white)] pt-32 pb-24">
      <div className="max-w-5xl mx-auto px-6 md:px-12">
        <FadeIn>
          <div className="mb-16">
            <h1 className="text-4xl md:text-5xl font-bold text-[var(--color-primary-dark)] mb-6">Privacy</h1>
            <p className="text-xl text-[var(--color-text-main)] leading-relaxed max-w-3xl">
              Discover how Quantra AI approaches privacy to deliver measurable business outcomes and architectural precision.
            </p>
          </div>
        </FadeIn>
        ...
        <section className="mb-20">
          <FadeIn direction="up">
            ...
            <p className="text-[var(--color-text-main)] mb-6">
              We do not sell hours. We sell capabilities. Every architecture decision in our Privacy solutions is measured against its ability to reduce costs, increase revenue, or mitigate risk. We build secure, scalable platforms using our Quantra Delivery OS.
            </p>
          </FadeIn>
        </section>

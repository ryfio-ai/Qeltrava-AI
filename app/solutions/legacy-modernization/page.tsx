...
export const metadata: Metadata = {
  ...
  description: 'Discover how Qeltrava AI approaches legacy modernization to deliver measurable business outcomes and architectural precision.',
};
        ...
        <FadeIn>
          <div className="mb-16">
            ...
            <p className="text-xl text-[var(--color-text-main)] leading-relaxed max-w-3xl">
              Discover how Qeltrava AI approaches legacy modernization to deliver measurable business outcomes and architectural precision.
            </p>
          </div>
        </FadeIn>
        ...
        <section className="mb-20">
          <FadeIn direction="up">
            ...
            <p className="text-[var(--color-text-main)] mb-6">
              We do not sell hours. We sell capabilities. We carefully refactor and migrate monolithic legacy systems into agile, cloud-native microservices, drastically reducing technical debt without disrupting ongoing business operations.
            </p>
          </FadeIn>
        </section>
